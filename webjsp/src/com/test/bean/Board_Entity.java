...
public class Board_Entity {
	...
	public String getReg_name( boolean han_yn ) { //데이타가 한글인 경우
		if(this.reg_name == null) { return "";	}
			...
			if(han_yn){	return this.reg_name;}
			/*{	return util.han(this.reg_name);}*/
	...
	public String getContent( boolean han_yn ) { 
		if(this.content == null) { return "";	}
			...
			if(han_yn){	return this.content;}
			/* { return util.han(this.content);} */
	...
	public String getFile_name1( boolean han_yn ) { 
		if(this.file_name1 == null) { return "";	}
			...
			if(han_yn){	return this.file_name1;}
			/* { return util.han(this.file_name1);} */
	...
	public String getQueryStr(boolean han_yn) {
		if(this.queryStr == null) { return "";	}
			...
			if(han_yn){	return this.queryStr;}
			/* { return util.han(this.queryStr);} */
	...
	public void setParser(HttpServletRequest request ) throws Exception {
		try{
			...
			String file_path  = request.getRealPath("/") + "board/attach_file/" ;//"d:\\home\\Ch09\\freeboard\\attach_file\\";
	 		MultipartRequest up = new MultipartRequest(request, file_path , 10*1024*1024 ,"utf-8", new DefaultFileRenamePolicy());//new DefaultFileRenamePolicy());
